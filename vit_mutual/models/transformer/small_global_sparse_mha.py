...
class GroupAttention(nn.Module):
    def __init__(
        ...
        self.linear_key_column = nn.Linear(embed_dim, embed_dim // num_head, bias=bias)
        self.linear_query_column = nn.Linear(embed_dim, embed_dim // num_head, bias=bias)
    ...
    def forward(self, context, prior):  # context: [n, bs, dim]
        ...
        scores_column = torch.matmul(query_column, key_column.transpose(-2, -1)) / math.sqrt(self.embed_dim // self.num_head)
        ...
        return g_attn, (neibor_attn, neibor_attn_column) 
