...
def save_checkpoint(state, is_best, checkpoint='checkpoint', filename='checkpoint_stage2.pth.tar', best_filename='model_best_stage2.pth.tar'):
...
def adjust_learning_rate2(args, optimizer, epoch):
    ...
    if epoch < 31 and epoch > 0 and epoch % 30 == 0:
...
def adjust_learning_rate4(args, optimizer, epoch):
    ...
    if epoch < 50 and epoch > 0 and epoch % 50 == 0:
        global_lr = global_lr/4
